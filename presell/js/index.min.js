                        ...
                        slideChangeTransitionEnd: function(e) {
                            try {
                                var t = this.slides[this.activeIndex],
                                    i = !1;
                                t.querySelector(".sl_video") && (i = Boolean(t.querySelector(".sl_video").dataset.autoplay)), this.slides[this.activeIndex].querySelectorAll(".wistia_embed").length > 0 && i ? (Wistia.api(this.slides[this.activeIndex].querySelector(".sl_video").dataset.videoid).play(), Wistia.api(this.slides[this.previousIndex].querySelector(".sl_video").dataset.videoid).pause()) : this.slides[this.activeIndex].querySelector(".wistia_embed_initialized") && (Wistia.api(this.slides[this.activeIndex].querySelector(".sl_video").dataset.videoid).pause(), Wistia.api(this.slides[this.previousIndex].querySelector(".sl_video").dataset.videoid).pause())
                            } catch (e) {
                                console.log(e)
                            }
                        }
...
window.addEventListener("load", function() {
    ...
    function() {
        ...
        function() {
            ...
            e.closest("section").classList.add("hidden")
        }), "0" === e("testi") && -1 !== window.location.pathname.indexOf("pre") && Array.prototype.slice.call(document.querySelectorAll(".fb-comments")).forEach(function(e) {
